...
<div class="d-flex justify-content-center align-items-center" style="height: 100vh; width: 100vw">        
          ...
          <div class="card-body">
            ...
            <p class="card-text d-flex justify-content-evenly">
                        <button class="btn btn-primary btn-sm"><a href="tel:+254705063256" style="text-decoration: none; color: inherit;"><i
                        ...
                        <button class="btn btn-primary btn-sm"><a href="sms:+254705063256" style="text-decoration: none; color: inherit;"><i
